...
<body>
    <?php 
     ...
     <div class="container mt-5 d-flex justify-content-center">
         <div class="card d-flex justify-content-center align-items-center" style="width: 50%;">
          <img src="../img/teacher-<?=$teacher['gender']?>.png" class="card-img-top w-25 d-flex justify-content-center " alt="...">
          <div class="card-body">
                  ...
                  <?php 
                     ...
                     foreach ($classes as $class_id) {
                        ...
                        if (is_array($c_temp) && is_array($section)){ 
                          ...
                          $c .= "Error retrieving grade or section information";
                        }
                         }else{
                          $c .= "Error retrieving class information";
                         }
                     }
                     echo $c;
