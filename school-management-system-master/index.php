...
<body class="body-home">
    <div class="black-fill"><br /> <br />
        ...
        <section class="welcome-text d-flex justify-content-center align-items-center flex-column">
        	<img src="sample.jpg" style="width: 500px; margin: 50px;">
        	<h4 class="head">Welcome to </h4>
			  ...
			  <div class="row g-0">
			    ...
			    <div class="col-md-8">
			      <div class="card-body">
					...
					<p>Welcome to Emerald Valley International School</p>
			        <p class="card-text"><?=$setting['about']?></p>
			        <p class="card-text"><small class="text-muted">Emerald Valley International School</small></p>
			      </div>
			    </div>
			  </div>
			</div>
			  ...
			  <div class="row g-0">
			    ...
			    <div class="col-md-8">
			      <div class="card-body">
					...
					<p>Our mission is to provide a holistic education that empowers students to become confident, compassionate, and responsible global citizens. We strive to foster a love of learning, creativity, and critical thinking, preparing our students for the challenges and opportunities of the 21st century.</p>
			        <p class="card-text"><small class="text-muted">Emerald Valley International School</small></p>
			      </div>
			    </div>
			  </div>
