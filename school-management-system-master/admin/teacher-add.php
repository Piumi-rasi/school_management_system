...
<body>
    <?php 
     ...
     ?>
     <div class="container mt-5 d-flex justify-content-center flex-column w-50">
        <a href="teacher.php"
           class="btn btn-dark w-25 ms-0">Go Back</a>

        <form method="post"
              class="shadow p-3 mt-5  d-flex flex-column justify-content-center w-100" 
